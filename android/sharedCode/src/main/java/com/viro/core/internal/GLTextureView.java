 ...
 *
 * Note that this file has been changed, as in accordance to the
 * redistribution terms as stated under this license.
 */
...
/**
 * An implementation of TextureView that instead uses a dedicated Texture for displaying
 * OpenGL rendering. TextureViews can have translucent backgrounds, thereby enabling Android
 * controls / content to be placed on top and/or below the rendered view.
 * <p>
 *
 * Note that this GLTexture view is actually a modified GLSurfaceView, that was tweaked to render
 * onto a TextureView, instead of a surface. As such, it does not have a dedicated window like
 * GLSurfaceViews, and thus may be slightly less performant than a GLSurfaceView. It was modified
 * according to https://stackoverflow.com/questions/12061419/converting-from-glsurfaceview-to-textureview-via-gltextureview.
 *
 * @hide
 */
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    private static class EglHelper {
        ...
        public static String formatEglError(String function, int error) {
            return function + " failed: " + function + " with error: " + error;
        }
